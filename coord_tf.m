...
%                 cell array.
%
%                 2.  M-file sl_info.m must be in the current path or
%                 directory.
%
%                 3.  See tf_coord.m for a transformation that first
